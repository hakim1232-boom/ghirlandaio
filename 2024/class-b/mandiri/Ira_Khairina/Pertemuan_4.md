...
## PEMBAHASAN
Terdapat kesalahan persepsi mengenai *hacking* pada masyarakat umum, berdasarkan buku *Troublemakers: Silicon Valley’s Coming of Age* karya Leslie Berlin, *hacking* pada era 1970-an tidak dipahami sebagai tindakan kriminal (kejahatan siber), melainkan merupakan `sebuah semangat untuk membongkar, memahami dan menyusun kembali suatu teknologi agar teknologi tersebut menjadi lebih baik`. Berbeda dengan *Cracking*, yaitu tindakan mengakses, memanipulasi, dan mengeksploitasi suatu sistem digital demi keuntungan pribadi secara ilegal (destruktif). 

Pada awalnya, *hacking* dilakukan demi kesenangan dalam memahami cara kerja teknologi dan memecahkan masalah teknis. Pada zaman dahulu, *hacking culture* sama seperti berkumpul bersama teman-teman atau yang lebih dikenal sebagai “nongkrong”. Mereka berkolaborasi dan berinovasi bersama melakukan pengembangan suatu teknologi. Masing-masing orang memiliki perannya sendiri. Mereka juga menyerukan kata “Hack!” yang berarti menciptakan solusi dengan cara yang cerdik dan tidak konvensional. Pada saat berkumpul, kata “Hack” sama seperti kata ajakan “Skuy!”.
